...
namespace App.Data.Migrations
{
    ...
    [Migration("20240425083937_init4")]
    partial class init4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 4, 25, 15, 39, 35, 158, DateTimeKind.Local).AddTicks(8327),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 25, 15, 39, 35, 158, DateTimeKind.Local).AddTicks(8484),
                            Slug = "san-pham",
                            Title = "Sản phẩm"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppOrderDetail", b =>
                {
                    ...
                    b.Property<int>("AppProdcutDetailId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 56, 43, 77, 206, 48, 246, 70, 74, 56, 11, 131, 100, 95, 149, 140, 139, 37, 98, 163, 229, 169, 252, 117, 160, 216, 249, 176, 39, 210, 11, 12, 71, 98, 144, 51, 38, 98, 56, 43, 10, 138, 40, 110, 39, 11, 48, 126, 34, 73, 20, 217, 152, 26, 13, 148, 216, 69, 135, 117, 71, 88, 114, 38, 149 },
                            PasswordSalt = new byte[] { 27, 224, 79, 23, 209, 244, 92, 50, 170, 141, 122, 189, 202, 131, 156, 215, 95, 76, 50, 228, 30, 218, 4, 224, 146, 62, 163, 200, 92, 31, 3, 174, 37, 114, 131, 254, 103, 161, 58, 254, 140, 219, 140, 20, 112, 197, 246, 218, 192, 200, 227, 92, 215, 153, 201, 99, 129, 203, 181, 98, 214, 255, 223, 103, 39, 36, 41, 71, 81, 80, 167, 177, 246, 77, 17, 24, 55, 200, 127, 63, 14, 132, 10, 43, 246, 188, 137, 161, 253, 207, 23, 212, 254, 12, 213, 134, 167, 138, 120, 242, 193, 68, 131, 173, 50, 200, 222, 62, 51, 103, 206, 247, 9, 213, 29, 143, 27, 136, 214, 153, 4, 204, 140, 250, 241, 194, 2, 7 },
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 25, 15, 39, 35, 158, DateTimeKind.Local).AddTicks(8395),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.Products.AppProdcutDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MstProductColorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MstProductColorId");

                    b.ToTable("AppProdcutDetail");
                });
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 4, 25, 15, 39, 35, 158, DateTimeKind.Local).AddTicks(8431),
                            CssColor = "#FF0000"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.AppOrderDetail", b =>
                {
                    b.HasOne("App.Data.Entities.Products.AppProdcutDetail", "AppProdcutDetail")
                        .WithMany("AppOrderDetails")
                        .HasForeignKey("AppProdcutDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("App.Data.Entities.Products.AppProdcutDetail", b =>
                {
                    ...
                    b.HasOne("App.Data.Entities.Products.MstProductColor", "MstProductColor")
                        ...
                        .HasForeignKey("MstProductColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
