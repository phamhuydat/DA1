...
namespace App.Data.Migrations
{
    ...
    [Migration("20240507033404_init_db8")]
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(4741),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(6318),
                            Slug = "tin-tuc-apple",
                            Title = "Tin tức Apple"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CateLevel = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(4831),
                            HasChild = true,
                            Name = "Iphone",
                            Slug = "iphone",
                            UpdatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(4831)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CanDelete = false,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(3146),
                            Desc = "Khách hàng",
                            Name = "Khách hàng",
                            UpdatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(3146)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppRoleId = 2,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(4185),
                            MstPermissionId = 1101,
                            UpdatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(4185)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 14, 33, 33, 174, 19, 116, 46, 159, 63, 251, 168, 3, 1, 71, 84, 45, 133, 250, 148, 205, 135, 91, 209, 8, 120, 90, 130, 64, 26, 162, 178, 89, 87, 59, 137, 58, 238, 195, 112, 214, 42, 150, 144, 84, 216, 125, 83, 149, 211, 98, 195, 123, 44, 130, 254, 87, 134, 91, 189, 160, 23, 103, 232, 212 },
                            PasswordSalt = new byte[] { 110, 242, 244, 236, 84, 119, 38, 170, 244, 237, 160, 28, 8, 151, 229, 252, 124, 115, 200, 204, 194, 5, 45, 255, 150, 136, 211, 180, 102, 45, 244, 100, 226, 11, 104, 42, 19, 238, 14, 69, 129, 181, 28, 33, 243, 204, 89, 25, 82, 233, 179, 164, 90, 41, 59, 192, 33, 100, 86, 193, 117, 111, 125, 58, 180, 228, 31, 155, 59, 198, 168, 117, 226, 182, 141, 112, 46, 60, 195, 59, 254, 44, 187, 49, 54, 205, 18, 159, 162, 9, 77, 145, 228, 167, 73, 244, 251, 185, 214, 55, 0, 166, 135, 146, 66, 205, 65, 70, 81, 59, 211, 45, 180, 93, 52, 26, 239, 81, 141, 230, 16, 174, 154, 155, 86, 108, 123, 156 },
            ...
            modelBuilder.Entity("App.Data.Entities.AppVoucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "voucher",
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(6588),
                            Percent = 10,
                            Price = 50m,
                            StartDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(6588)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(6253),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.MstPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1103,
                            Code = "CREATE",
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(2831),
                            Desc = "Thêm quyền",
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 5, 7, 10, 34, 3, 349, DateTimeKind.Local).AddTicks(6286),
                            CssColor = "#FF0000"
                        },
                        new
                        {
