...
namespace App.Data.Migrations
{
    ...
    [Migration("20240417104433_edit4")]
    partial class edit4
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 4, 17, 17, 44, 31, 707, DateTimeKind.Local).AddTicks(9435),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 17, 17, 44, 31, 707, DateTimeKind.Local).AddTicks(9606),
                            Slug = "san-pham",
                            Title = "Sản phẩm"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 68, 6, 176, 9, 217, 133, 158, 38, 224, 163, 4, 85, 34, 79, 115, 248, 182, 118, 77, 220, 35, 99, 134, 183, 69, 156, 88, 254, 29, 79, 134, 168, 185, 180, 234, 145, 181, 28, 144, 138, 113, 117, 138, 154, 189, 146, 144, 114, 72, 175, 141, 35, 216, 46, 6, 13, 30, 212, 60, 92, 13, 208, 184, 178 },
                            PasswordSalt = new byte[] { 154, 171, 14, 150, 39, 102, 143, 126, 154, 231, 141, 113, 132, 65, 54, 124, 8, 202, 78, 174, 198, 31, 72, 103, 163, 217, 191, 66, 148, 9, 59, 55, 60, 84, 89, 229, 173, 94, 129, 114, 213, 68, 125, 210, 214, 193, 85, 202, 194, 43, 79, 127, 16, 152, 134, 45, 91, 158, 153, 101, 242, 14, 39, 95, 196, 36, 168, 117, 51, 139, 156, 76, 245, 36, 181, 243, 68, 34, 186, 66, 14, 253, 38, 142, 156, 118, 40, 243, 146, 168, 169, 208, 25, 53, 178, 127, 175, 161, 41, 166, 64, 55, 21, 148, 153, 222, 29, 43, 160, 50, 108, 100, 117, 13, 37, 210, 44, 153, 163, 148, 136, 177, 49, 67, 52, 151, 205, 163 },
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 17, 17, 44, 31, 707, DateTimeKind.Local).AddTicks(9535),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 4, 17, 17, 44, 31, 707, DateTimeKind.Local).AddTicks(9576),
                            CssColor = "#FF0000"
                        },
                        new
                        {
