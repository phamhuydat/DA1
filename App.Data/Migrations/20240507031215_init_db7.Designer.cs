...
namespace App.Data.Migrations
{
    ...
    [Migration("20240507031215_init_db7")]
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(1909),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(3341),
                            Slug = "tin-tuc-apple",
                            Title = "Tin tức Apple"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CateLevel = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(2030),
                            HasChild = true,
                            Name = "Iphone",
                            Slug = "iphone",
                            UpdatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(2030)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CanDelete = false,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(490),
                            Desc = "Khách hàng",
                            Name = "Khách hàng",
                            UpdatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(490)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppRoleId = 2,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(1484),
                            MstPermissionId = 1101,
                            UpdatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(1484)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 160, 144, 116, 4, 241, 13, 17, 166, 133, 56, 22, 128, 193, 250, 169, 97, 236, 19, 166, 150, 6, 104, 67, 73, 239, 37, 209, 227, 125, 1, 33, 157, 114, 192, 205, 182, 73, 186, 130, 198, 112, 151, 81, 173, 23, 181, 191, 126, 224, 3, 61, 180, 152, 117, 94, 125, 4, 201, 8, 62, 39, 17, 47, 174 },
                            PasswordSalt = new byte[] { 167, 2, 11, 25, 104, 132, 187, 142, 241, 120, 208, 246, 182, 69, 226, 19, 118, 145, 18, 66, 204, 88, 61, 38, 225, 97, 30, 84, 100, 210, 18, 145, 54, 207, 189, 253, 142, 112, 219, 20, 158, 95, 13, 179, 247, 249, 5, 19, 168, 132, 39, 203, 146, 86, 112, 241, 148, 24, 47, 198, 76, 66, 250, 166, 180, 147, 226, 8, 62, 191, 138, 255, 170, 93, 123, 180, 166, 203, 144, 99, 21, 92, 238, 69, 200, 75, 126, 177, 84, 225, 191, 245, 191, 62, 37, 168, 192, 76, 9, 64, 217, 34, 71, 2, 232, 161, 145, 45, 63, 219, 65, 169, 184, 242, 142, 77, 16, 229, 30, 190, 236, 212, 26, 30, 34, 196, 208, 100 },
            ...
            modelBuilder.Entity("App.Data.Entities.AppVoucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "voucher",
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(3563),
                            Description = "mã này chỉ để Test chức năng",
                            DiscountPrice = 50m,
                            StartDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(3563)
                        });
                });
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(3289),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.MstPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1103,
                            Code = "CREATE",
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(244),
                            Desc = "Thêm quyền",
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 5, 7, 10, 12, 14, 344, DateTimeKind.Local).AddTicks(3317),
                            CssColor = "#FF0000"
                        },
                        new
                        {
