...
namespace App.Data.Migrations
{
    ...
    [Migration("20240420032950_init2")]
    partial class init2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 4, 20, 10, 29, 49, 869, DateTimeKind.Local).AddTicks(6455),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 20, 10, 29, 49, 869, DateTimeKind.Local).AddTicks(6630),
                            Slug = "san-pham",
                            Title = "Sản phẩm"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 111, 37, 93, 65, 244, 81, 127, 122, 60, 194, 75, 130, 182, 171, 246, 64, 212, 5, 220, 117, 127, 74, 216, 84, 151, 214, 195, 230, 26, 111, 203, 40, 99, 173, 59, 119, 217, 206, 105, 162, 177, 109, 27, 40, 131, 97, 148, 14, 240, 158, 196, 218, 239, 105, 195, 91, 136, 236, 241, 209, 46, 29, 68, 131 },
                            PasswordSalt = new byte[] { 58, 40, 37, 36, 56, 66, 83, 149, 129, 89, 0, 130, 38, 248, 109, 225, 87, 158, 107, 206, 33, 65, 89, 15, 82, 62, 81, 238, 156, 195, 59, 106, 177, 115, 186, 240, 14, 109, 77, 30, 58, 229, 63, 25, 169, 147, 251, 233, 65, 179, 239, 68, 79, 104, 52, 41, 241, 82, 229, 183, 39, 167, 117, 42, 233, 144, 35, 120, 31, 229, 52, 160, 67, 227, 42, 44, 13, 12, 26, 106, 183, 60, 28, 181, 26, 119, 190, 25, 70, 129, 99, 186, 90, 121, 10, 195, 0, 13, 161, 135, 98, 130, 128, 144, 174, 142, 190, 156, 189, 108, 92, 75, 217, 95, 17, 125, 29, 230, 137, 101, 244, 31, 202, 128, 241, 37, 22, 193 },
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 20, 10, 29, 49, 869, DateTimeKind.Local).AddTicks(6531),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 4, 20, 10, 29, 49, 869, DateTimeKind.Local).AddTicks(6604),
                            CssColor = "#FF0000"
                        },
                        new
                        {
