...
namespace App.Data.Migrations
{
    ...
    [Migration("20240523154018_init-111")]
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(8608),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 110, DateTimeKind.Local).AddTicks(323),
                            Slug = "tin-tuc-apple",
                            Title = "Tin tức Apple"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CateLevel = 1,
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(8699),
                            HasChild = true,
                            Name = "Iphone",
                            Slug = "iphone",
                            UpdatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(8699)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CanDelete = false,
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(6823),
                            Desc = "Khách hàng",
                            Name = "Khách hàng",
                            UpdatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(6823)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppRoleId = 2,
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(7949),
                            MstPermissionId = 1101,
                            UpdatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(7949)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 201, 62, 5, 71, 162, 64, 112, 43, 203, 175, 33, 185, 222, 130, 25, 254, 110, 135, 91, 165, 209, 142, 241, 73, 150, 26, 57, 13, 240, 72, 94, 170, 193, 169, 180, 212, 81, 47, 75, 228, 126, 118, 218, 198, 145, 90, 56, 140, 183, 104, 186, 171, 236, 101, 248, 130, 124, 141, 168, 103, 10, 171, 17, 207 },
                            PasswordSalt = new byte[] { 233, 83, 66, 220, 255, 208, 223, 209, 147, 189, 86, 145, 139, 12, 202, 143, 57, 116, 147, 143, 18, 232, 69, 130, 101, 187, 156, 32, 34, 76, 59, 103, 245, 116, 241, 36, 204, 236, 30, 222, 81, 35, 114, 96, 41, 153, 162, 24, 131, 7, 212, 11, 83, 24, 5, 79, 205, 192, 77, 69, 154, 34, 139, 140, 25, 232, 146, 9, 179, 195, 6, 117, 13, 91, 240, 129, 96, 92, 237, 124, 1, 216, 244, 177, 69, 230, 41, 71, 139, 69, 11, 133, 22, 147, 38, 12, 75, 184, 96, 154, 92, 255, 188, 78, 210, 201, 62, 0, 13, 255, 75, 11, 241, 26, 77, 73, 129, 3, 147, 42, 186, 108, 220, 40, 15, 30, 55, 159 },
            ...
            modelBuilder.Entity("App.Data.Entities.AppVoucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "voucher",
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 110, DateTimeKind.Local).AddTicks(540),
                            Percent = 10,
                            Price = 50m,
                            StartDate = new DateTime(2024, 5, 23, 22, 40, 16, 110, DateTimeKind.Local).AddTicks(540)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 110, DateTimeKind.Local).AddTicks(219),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.MstPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1103,
                            Code = "CREATE",
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 109, DateTimeKind.Local).AddTicks(6517),
                            Desc = "Thêm quyền",
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 5, 23, 22, 40, 16, 110, DateTimeKind.Local).AddTicks(288),
                            CssColor = "#FF0000"
                        },
                        new
                        {
