...
namespace App.Data.Migrations
{
    ...
    [Migration("20240425084540_init6")]
    partial class init6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 4, 25, 15, 45, 39, 668, DateTimeKind.Local).AddTicks(8554),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 25, 15, 45, 39, 668, DateTimeKind.Local).AddTicks(8889),
                            Slug = "san-pham",
                            Title = "Sản phẩm"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 140, 149, 65, 27, 93, 122, 8, 140, 96, 18, 199, 6, 187, 175, 19, 99, 117, 117, 109, 104, 79, 244, 78, 48, 238, 11, 194, 118, 216, 142, 251, 14, 99, 118, 174, 232, 54, 27, 134, 83, 176, 181, 80, 255, 128, 85, 71, 65, 68, 112, 32, 125, 113, 77, 111, 59, 170, 180, 228, 241, 99, 252, 130, 178 },
                            PasswordSalt = new byte[] { 38, 62, 214, 31, 171, 14, 174, 131, 125, 101, 199, 24, 179, 5, 157, 215, 223, 254, 105, 132, 145, 167, 47, 148, 32, 15, 187, 208, 138, 34, 117, 142, 237, 83, 171, 150, 66, 155, 234, 145, 235, 82, 203, 24, 32, 12, 109, 142, 83, 138, 48, 185, 163, 118, 0, 75, 24, 181, 34, 41, 4, 4, 126, 10, 154, 180, 61, 56, 70, 235, 93, 82, 236, 38, 216, 232, 206, 176, 172, 173, 24, 171, 150, 204, 172, 159, 117, 45, 59, 27, 236, 119, 132, 182, 28, 223, 124, 122, 117, 135, 58, 106, 0, 55, 159, 123, 201, 133, 201, 96, 117, 131, 211, 143, 83, 233, 233, 85, 171, 161, 139, 107, 24, 193, 215, 27, 238, 156 },
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 4, 25, 15, 45, 39, 668, DateTimeKind.Local).AddTicks(8659),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 4, 25, 15, 45, 39, 668, DateTimeKind.Local).AddTicks(8864),
                            CssColor = "#FF0000"
                        },
                        new
                        {
