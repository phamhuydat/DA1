...
namespace App.Data.Migrations
{
    ...
    [Migration("20240524144307_inti-113")]
    partial class inti113
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Data.Entities.AppBranch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(7832),
            ...
            modelBuilder.Entity("App.Data.Entities.AppNewsCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(9166),
                            Slug = "tin-tuc-apple",
                            Title = "Tin tức Apple"
                        },
                        new
            ...
            modelBuilder.Entity("App.Data.Entities.AppProductCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CateLevel = 1,
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(7921),
                            HasChild = true,
                            Name = "Iphone",
                            Slug = "iphone",
                            UpdatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(7921)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CanDelete = false,
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(6583),
                            Desc = "Khách hàng",
                            Name = "Khách hàng",
                            UpdatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(6583)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppRolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AppRoleId = 2,
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(7464),
                            MstPermissionId = 1101,
                            UpdatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(7464)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Lilocon",
                            PasswordHash = new byte[] { 160, 18, 213, 28, 216, 65, 235, 121, 190, 208, 231, 0, 119, 167, 77, 143, 5, 55, 156, 212, 244, 165, 91, 55, 133, 247, 15, 51, 243, 13, 251, 6, 10, 92, 153, 125, 106, 182, 42, 22, 8, 129, 148, 80, 220, 60, 54, 242, 129, 228, 236, 169, 210, 159, 174, 78, 200, 115, 35, 64, 21, 63, 236, 84 },
                            PasswordSalt = new byte[] { 126, 242, 176, 139, 160, 173, 48, 237, 67, 142, 84, 9, 132, 234, 15, 114, 52, 115, 146, 29, 218, 116, 207, 96, 136, 88, 109, 146, 39, 179, 99, 203, 124, 127, 211, 48, 234, 55, 94, 44, 195, 21, 136, 239, 207, 133, 25, 46, 149, 196, 96, 130, 176, 74, 7, 106, 32, 32, 161, 120, 86, 171, 140, 206, 159, 245, 171, 230, 134, 164, 191, 124, 215, 248, 224, 160, 13, 240, 64, 57, 161, 94, 219, 52, 72, 124, 167, 3, 198, 250, 255, 91, 10, 90, 90, 43, 43, 168, 159, 51, 216, 254, 47, 202, 111, 25, 171, 211, 117, 65, 68, 13, 62, 108, 11, 188, 103, 200, 61, 248, 221, 134, 12, 171, 0, 167, 91, 177 },
            ...
            modelBuilder.Entity("App.Data.Entities.AppVoucher", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "voucher",
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(9350),
                            Percent = 10,
                            Price = 50m,
                            StartDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(9350)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("App.Data.Entities.MstOrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(9106),
                            Name = "Đang xử lý"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("App.Data.Entities.MstPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1103,
                            Code = "CREATE",
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(6350),
                            Desc = "Thêm quyền",
            ...
            modelBuilder.Entity("App.Data.Entities.Products.MstProductColor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ColorName = "Red",
                            CreatedDate = new DateTime(2024, 5, 24, 21, 43, 4, 890, DateTimeKind.Local).AddTicks(9136),
                            CssColor = "#FF0000"
                        },
                        new
                        {
