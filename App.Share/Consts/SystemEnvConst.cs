...
{
	public static class SystemEnvConst
	{
		// Thông tin cơ bản
		...
		public const string SECONDARY_PHONE = "SecondaryPhone";
		...
		public const string COMPANY_INTRODUCE_IMAGE_4 = "CompanyIntroduceImage4";

		public const string EMAIL_FOR_ORDER_INFORMATION = "EmailForOrderInformation";
	}
}
