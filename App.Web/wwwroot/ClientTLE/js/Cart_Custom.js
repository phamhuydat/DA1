...
//                        var html = `<tr class="append-item" data-id="">
//                                            @* img *@
//                                            <td class="product-picture">
//                                                <a>
//                                                    <img src="${pathImgP}" alt="${productName}"/>
//                                                </a>
//                                            </td>
//                                            @* name *@
//                                            <td class="product">
...
//                                                </a>
//                                                <div class="edit-item">
//                                                    <a asp-action="ProdcutDetail" asp-controller="Prodcut" asp-route-id=" ${id}">Sửa</a>
//                                                </div>
//                                            </td>
//                                            @* price *@
//                                            <td class="unit-price">
//                                                <label class="td-title">Giá bán:</label>
//                                                <span class="product-unit-price">${price.toLocaleString("de-DE")}</span>
//                                                <span class="product-unit-price" hidden>${price}</span>
//                                            </td>
//                                            @* quantity *@
//                                            <td class="quantity">
//                                                <div class="cart-quantity-input-container">
//                                                    <a class="giam" style="color: blue">-</a>
//                                                    <input id="quantity"
//                                                        type="text" value="${stringaray[0]}"
//                                                        aria-label="quantity" class="qty-input" />
//                                                    <a class="tang" style="color: blue" >+</a>
//                                                </div>
//                                            </td>
//                                            <td class="remove-from-cart">
//                                                <button type="button" class="remove-btn once-submit-button removecookies"></button>
//                                            </td>
//                                        </tr>`;
