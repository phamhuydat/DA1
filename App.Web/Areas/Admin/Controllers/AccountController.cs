...
namespace App.Web.Areas.Admin.Controllers
{
	public class AccountController : AppControllerBase
	{
		...
		[HttpPost]
		public async Task<IActionResult> ForgotPassword(string email = "", bool isClient = false)
		{
		...
		[HttpPost]
		public async Task<IActionResult> CreateNewPass(ForgotPassword model, bool isClient)
		{
