...
namespace App.Web.Areas.Admin.Controllers
{
	public class AccountController : AppControllerBase
    {
		...
		[HttpPost]
		public async Task<IActionResult> ForgotPassword([FromServices] SystemEnvironment sysEnv, string email = "", bool isClient = false)
		{
			...
			if (user != null)
			{
				...
				{
					Name = sysEnv[SystemEnvConst.BRAND_NAME],
		...
		[HttpPost]
		public async Task<IActionResult> CreateNewPass([FromServices] SystemEnvironment sysEnv, ForgotPassword model, bool isClient)
		{
