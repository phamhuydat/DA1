...
namespace App.Web.Areas.Admin.Components.SelectProductColor2
{
    public class SelectProductColor2ViewComponent : ViewComponent
    {
        readonly GenericRepository repository;
        public SelectProductColor2ViewComponent(GenericRepository _db)
        {
            repository = _db;
        }
